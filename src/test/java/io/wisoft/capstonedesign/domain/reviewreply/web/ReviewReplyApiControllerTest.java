...
class ReviewReplyApiControllerTest extends ApiTest {
    ...
    private ExtractableResponse<Response> updateReviewReply(final int targetReviewReplyId, final UpdateReviewReplyRequest request) {
        return RestAssured
                .given()
                .log().all()
    ...
    private ExtractableResponse<Response> deleteReviewReply(final int targetReviewReplyId) {
        return RestAssured
                .given()
                .log().all()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    private ExtractableResponse<Response> createReviewReply(final CreateReviewReplyRequest request) {
        return RestAssured
                .given()
                .log().all()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    private CreateReviewReplyRequest getCreateReviewReplyRequest() {
